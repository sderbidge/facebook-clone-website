  ...
  <div class="root">
    ...
    <div class="wrapper">
      <div class="main-content">
        <div v-if="this.$root.$data.sessionTimedOut">
          <h1>SESSION TIMED OUT. PLEASE REFRESH AND TRY AGAIN</h1>
        </div>
        <div v-else>
          <div class="sign-in">
            <h3>Sign in with Lets Auth</h3>
            <QRCode />
            <p>Scan the QR code above with your authenticator app to sign in or register.</p>
          </div>
        </div>
      </div>
    </div>
